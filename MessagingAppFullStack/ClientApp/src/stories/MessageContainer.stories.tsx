...
export const Default = () => {
    ...
    const user1 = {id: 0, name: "Lachlan Johnson", avatar: "https://thispersondoesnotexist.com/image"}
    const user2 = {id: 1, name: "Bob Newman", avatar: 'https://source.unsplash.com/random/300×300'}
    ...
    return (
        <MessageContainer activeUser={user1}>
            {messages.map(({user, content, timestamp}) => <MessageComponent user={user} content={content} />)}
        </MessageContainer>
    )
}